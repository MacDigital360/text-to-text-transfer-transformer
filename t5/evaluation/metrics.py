...
def rank_classification(
  ...
  For problems with two labels, retrieval metrics will be reported for the
  positive class which is assumed to have an 'idx' of 1. If more labels are
  present, retrieval metrics will be macro averaged over the retrieval metrics
